...
export default function NavBar() {
  ...
  return (
    <header className="flex items-center justify-between w-full px-6 py-5 mx-auto  rounded ">
      ...
      <Button
        className="px-4 py-2 text-sm font-semibold text-white shadow-sm bg-gradient-to-br from-rose-500 via-red-400 to-red-500 hover:bg-pink-700 cursor-pointer"
